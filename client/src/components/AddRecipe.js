  ...
  return (
    <span style={{ opacity: 1, backgroundColor: 'white', fontWeight: 'bold' }}>
      <div className="overflow-auto bg-gray-100 p-4 rounded-xl shadow-md h-auto">
        ...
        <input
          className={`opacity-100 my-1.5 w-full h-1/4 px-5 ${colorTheme} min-h-10 max-h-96 p-2 border border-gray-300 rounded-full focus:outline-none focus:ring focus:border-blue-500`}
          value={name}
        ...
        <textarea
          className={`opacity-100 h-80 my-1.5 w-full px-5 ${colorTheme} min-h-10 p-2 border border-gray-300 rounded-3xl focus:outline-none focus:ring focus:border-blue-500`}
          value={ingredients}
        ...
        />
        <textarea
          className={`opacity-100 my-1.5 w-full h-80 min-h-10 px-5 ${colorTheme} p-2 border border-gray-300 rounded-3xl focus:outline-none focus:ring focus:border-blue-500`}
          value={instructions}
